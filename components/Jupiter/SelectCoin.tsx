...
import defaultCoin from "../../images/default-coin.png";
...
const Row = ({
  ...
  return (
    ...
    >
        ...
        <div>
          <img
            onError={({ currentTarget }) => {
              ...
              currentTarget.src = defaultCoin as any;
            }}
            src={info.logoURI ? info.logoURI : ""}
            width={35} height={35}
            alt=""
          />
        </div>
      ...
      <Link className="btn z-1" href={"https://solscan.io/account/" + info.address}>
...
const Coin = ({ tokenInfo }: { tokenInfo: TokenInfo }) => {
  return (
    <div className="flex flex-row items-center justify-start">
      <img
        src={tokenInfo?.logoURI ? tokenInfo?.logoURI : ""}
        onError={({ currentTarget }) => {
          currentTarget.onerror = null; // prevents looping
          currentTarget.src = defaultCoin as any;
        }}
...
const TopCoin = ({
  ...
  return (
    ...
    >
      <img  className="w-[18px] h-[18px] mr-2" src={token.logoURI ? token.logoURI : ""} alt=""/>
