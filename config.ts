interface ENV {
  ...
  NEXT_PUBLIC_JUPITER_FEE_WALLET_ADDRESS: string | undefined;
...
const getConfig = (): ENV => {
  return {
    ...
    NEXT_PUBLIC_JUPITER_FEE_WALLET_ADDRESS: process.env.NEXT_PUBLIC_JUPITER_FEE_WALLET_ADDRESS,
    NEXT_PUBLIC_JUPITER_FEE_BPS: process.env.NEXT_PUBLIC_JUPITER_FEE_BPS ? parseInt(process.env.NEXT_PUBLIC_JUPITER_FEE_BPS) : 0
  };
};
